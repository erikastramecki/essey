...
//
// TESTNET: deploys a MockEntropy keeper (real Dice isn't confirmed on 46630), wires EsseyCasesDegen
// with the disclosed 0.65x-50x / ~90% RTP ladder (reference denominated in SHARES — no oracle, open
// 24/7), and seeds the reserve.
    ...
    function run() external {
        ...
        EsseyCasesDegen degen = new EsseyCasesDegen(
            EsseyCasesDegen.Config({
                ...
                referenceShares: vm.envOr("DEGEN_REFERENCE_SHARES", uint256(5e17)), // 0.5 stock unit at 1x
