...
const PICK = [
  ...
  ["The Market", "TOKENOMICS-v3.md", "Tokenomics v3 — the Dons", "8,888 Dons: a seat, a floor, and a margin account in one NFT. Fixed-supply $ESSEY, the 300,030 floor that only rises, the five-rung tier ladder, exchange fees that buy stock for holders, and $ESSEY loans with provable solvency — every number reconciled to the deployed contracts."],
