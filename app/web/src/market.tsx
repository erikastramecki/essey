  ...
  return (
    <div className="toy">
      ...
      <div className="toy-note"><b>{nm}</b>: a one-time <b className="num">{fee.toLocaleString()} $ESSEY</b> activation
        ...
        Fees are cumulative, so upgrading later costs only the difference. The fee is a sink, not a deposit:
...
function MintToy() {
  const PATHS = [
    ["Whitelist", "free · gas only", "Hold an allocation and claim your Dons for gas. Traits roll random; reroll as much as you like before you stake. The whitelist is a Merkle root committed on-chain behind a 2-day public timelock, so no one can swap it in quietly."],
  ...
  return (
    <div className="toy">
      ...
      <div className="toy-note">Behind every Don sits a reserve seeded with <b className="num">2,666,666,666
        ...
        floor share, no permission, no window, no admin. That is why a Don can never trade below the floor.
  ...
  return (
    <div className="toy">
      ...
      <div className="toy-note">The desk trades at the <b>live redemption floor</b>, read fresh from the reserve on
        every trade, so it can never be arbitraged against a risen floor. Buy the next Don (+8%), snipe the exact #
  ...
  return (
    <div className="toy">
      ...
      <div className="toy-note">Elect <b>up to 3 tokenized stocks</b> with your own split, or elect nothing and
        ...
        arrives as USDG instead, so your money is never stuck behind a swap. Elections clear when the Don changes
        ...
        <div className="twist-grid">
          ...
          <div className="twist-card">
            ...
            <p>The Payouts come from a lending engine whose solvency rule is machine-checked. Every Don loan emits a
              solvency statement (debt ≤ 50% of floor) proven on-chain, and its audit rounds are published clean
