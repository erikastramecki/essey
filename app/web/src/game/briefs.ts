...
export const BRIEFS: Record<BriefKey, GameBrief> = {
  paper: {
    ...
    takeLine: "36 Scrip on a clean run, 14.4 if it goes sideways.",
    risk: "A 7% bust band, and a 3-hour window with your House standing open.",
  ...
  glass: {
    ...
    risk: "A 12% bust band, and a 5-hour window with your House standing open.",
  ...
  pow: {
    ...
    takeLine: "236 Scrip for the full cycle, 94.4 for a partial cut.",
    risk: "An 18% bust band, and a 12-hour window with your House standing open.",
    word: "The Rig turns the city's power bill into digital gold and doesn't much care whose address is on the payout line — that's a config file, and config files can be edited by anyone standing in the right hall at the right hour. Twelve hours on the swing shift, one cutover, no alarms: the machines genuinely cannot tell. You did the work. Here's the proof.",
    odds: [60, 22, 18],
    successPay: S(236),
    partialPay: S(94.4),
    dispatchFee: S(2.44),
  ...
  zero: {
    ...
    takeLine:
      "2,775 Scrip if the dewar makes it out, 222 for fragments. 65% of the time, nothing.",
    risk: "A 65% bust band, and a 24-hour window with your House standing open.",
  ...
  deeprun: {
    ...
    risk: "The only posting on the board where your stake is a real loss. Provision the full 500 and a clean return adds 450 on top, but clean lands 12% of the time: about 54 Scrip back on 500 staked. Every other brief hands back 90 on the hundred. This one does not.",
    word: "Sixteen hours out, sixteen hours your House stands open, and no wire to tell you how it's going. Nobody watches the Deep Run because there is nothing out there to watch from. Most crews come back with a story and an empty truck. About one in eight comes back with the thing that pays for the year.",
    odds: [12, 18, 70],
    successPay: S(800),
    partialPay: S(60),
    dispatchFee: S(1.6),
  ...
  sprint: {
    ...
    takeLine:
      "6,000 Scrip on a clean run: a Hitter off the rack is 900, a hit order is 50.",
    risk: "Training wire. 75 seconds of exposure, and a 0.05% bust band.",
  ...
  windowjob: {
    ...
    takeLine: "100 Scrip on a clean run.",
    risk: "The raid-practice wire: your hopper is exposed for 20 minutes.",
    word: "You want to learn how robberies feel from both sides? Take the window job and tell a friend when you leave. The reveal clock runs ten minutes, the window runs twenty.",
    odds: [98.5, 1.45, 0.05],
    successPay: S(100),
    partialPay: S(40),
    dispatchFee: S(1),
